export const SkillsData = [
  {
    id: 1,
    position: "Frontend",
    skills: "HTML·CSS·React·React-Native·React-Navigation·React-Hooks",
  },
  { id: 2, position: "Backend", skills: "Node.js·Express·MySQL·Sequelize" },
  {
    id: 3,
    position: "Development Tools",
    skills: "Git·AWS·Visual Studio Code",
  },
];
